...
class ReflectionFunctionTest extends \PHPUnit_Framework_TestCase
{
    public function testConstructor()
    {
        ...
        $this->assertInstanceOf('Laminas\Server\Reflection\ReflectionFunction', $r);
    ...
    public function testGetPrototypes()
    {
        ...
        foreach ($prototypes as $p) {
            $this->assertInstanceOf('Laminas\Server\Reflection\Prototype', $p);
        }
    }
    ...
    public function testClassWakeup()
    {
        ...
        $s = serialize($r);
        $u = unserialize($s);
        $this->assertInstanceOf('Laminas\Server\Reflection\ReflectionFunction', $u);
